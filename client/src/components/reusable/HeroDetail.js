         ...
         <Container>
            <Row>
               <Col xs={12} lg={6} className="text-center">
                  <img src={restaurant} alt="restaurant" className="w-100 w-lg-100" />
               </Col>
               <Col xs={12} lg={6} className="d-flex flex-column justify-content-center">
                  <h1 style={{ fontSize: "6rem" }} className="heading display-4 font-weight-bold text-white">
                     {data?.fullName}
                  </h1>
                  <p style={{ fontSize: "2rem" }} className="text-warning ">
                     Restaurant
                  </p>
