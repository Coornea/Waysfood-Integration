         ...
         case "delivery":
            return (
               ...
               >
                  <Row className="mb-2">
                     <Col>
                        <h5 className="font-weight-bold mb-0">Select delivery location</h5>
                     </Col>
                  </Row>
                  <Row className="mb-3">
                     <Col lg={2}>
                  ...
                  <Row>
                     <Col>
                        <Button onClick={handleLocation} variant="brown" className="w-100">
                           Confirm Location
                        </Button>
                     </Col>
                  </Row>
         ...
         case "order":
            return (
               ...
               >
                  <Row className="mb-4">
                     <Col>
                        <h5 className="font-weight-bold mb-0">Waiting for the transaction to be approved</h5>
                     </Col>
                  </Row>
                  <Row className="mb-5">
                     <Col lg={2}>
                  ...
                  {isFinished && (
                     <Row className="mt-4">
                        <Col lg={12}>
                           <Button variant="brown" className="w-100" onClick={handleFinished}>
                              Finished Order
                           </Button>
                        </Col>
                     </Row>
   ...
   return (
      <Modal show={show} dialogClassName="custom-modal" onHide={handleMapClose}>
         <Modal.Body style={{ position: "relative" }}>
            <MapRender isMarker={from === "delivery" || (from === "user" && true)} />
            {renderDialog()}
         </Modal.Body>
      </Modal>
   );
